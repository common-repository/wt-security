...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters(): array
    {
        return [
            // formatting filters
            new TwigFilter('date', 'wt_twig_date_format_filter', ['needs_environment' => true]),
            new TwigFilter('date_modify', 'wt_twig_date_modify_filter', ['needs_environment' => true]),
            new TwigFilter('format', 'sprintf'),
            new TwigFilter('replace', 'wt_twig_replace_filter'),
            new TwigFilter('number_format', 'wt_twig_number_format_filter', ['needs_environment' => true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', 'wt_twig_round'),

            // encoding
            new TwigFilter('url_encode', 'wt_twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', 'wt_twig_convert_encoding'),

            // string filters
            new TwigFilter('title', 'wt_twig_title_string_filter', ['needs_environment' => true]),
            new TwigFilter('capitalize', 'wt_twig_capitalize_string_filter', ['needs_environment' => true]),
            new TwigFilter('upper', 'wt_twig_upper_filter', ['needs_environment' => true]),
            new TwigFilter('lower', 'wt_twig_lower_filter', ['needs_environment' => true]),
            new TwigFilter('striptags', 'strip_tags'),
            new TwigFilter('trim', 'wt_twig_trim_filter'),
            new TwigFilter('nl2br', 'nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', 'wt_twig_spaceless', ['is_safe' => ['html']]),

            // array helpers
            new TwigFilter('join', 'wt_twig_join_filter'),
            new TwigFilter('split', 'wt_twig_split_filter', ['needs_environment' => true]),
            new TwigFilter('sort', 'wt_twig_sort_filter'),
            new TwigFilter('merge', 'wt_twig_array_merge'),
            new TwigFilter('batch', 'wt_twig_array_batch'),
            new TwigFilter('column', 'wt_twig_array_column'),
            new TwigFilter('filter', 'wt_twig_array_filter', ['needs_environment' => true]),
            new TwigFilter('map', 'wt_twig_array_map', ['needs_environment' => true]),
            new TwigFilter('reduce', 'wt_twig_array_reduce', ['needs_environment' => true]),

            // string/array filters
            new TwigFilter('reverse', 'wt_twig_reverse_filter', ['needs_environment' => true]),
            new TwigFilter('length', 'wt_twig_length_filter', ['needs_environment' => true]),
            new TwigFilter('slice', 'wt_twig_slice', ['needs_environment' => true]),
            new TwigFilter('first', 'wt_twig_first', ['needs_environment' => true]),
            new TwigFilter('last', 'wt_twig_last', ['needs_environment' => true]),

            // iteration and runtime
            new TwigFilter('default', 'wt_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', 'wt_twig_get_array_keys_filter'),
        ];
    }
    ...
    public function getFunctions(): array
    {
        return [
            ...
            new TwigFunction('constant', 'wt_twig_constant'),
            new TwigFunction('cycle', 'wt_twig_cycle'),
            new TwigFunction('random', 'wt_twig_random', ['needs_environment' => true]),
            new TwigFunction('date', 'wt_twig_date_converter', ['needs_environment' => true]),
            new TwigFunction('include', 'wt_twig_include', ['needs_environment' => true, 'needs_context' => true, 'is_safe' => ['all']]),
            new TwigFunction('source', 'wt_twig_source', ['needs_environment' => true, 'is_safe' => ['all']]),
        ];
    }
    ...
    public function getTests(): array
    {
        return [
            ...
            new TwigTest('empty', 'wt_twig_test_empty'),
            new TwigTest('iterable', 'wt_twig_test_iterable'),
        ];
    }
 ...
 */
function wt_twig_cycle($values, $position)
{
 ...
 */
function wt_twig_random(Environment $env, $values = null, $max = null)
{
    if (null === $values) {
    ...
    if (\is_string($values)) {
        ...
        if ('UTF-8' !== $charset) {
            $values = wt_twig_convert_encoding($values, 'UTF-8', $charset);
        }
        ...
        if ('UTF-8' !== $charset) {
            foreach ($values as $i => $value) {
                $values[$i] = wt_twig_convert_encoding($value, $charset, 'UTF-8');
            }
        }
    }

    if (!wt_twig_test_iterable($values)) {
        return $values;
    }

    $values = wt_twig_to_array($values);
 ...
 */
function wt_twig_date_format_filter(Environment $env, $date, $format = null, $timezone = null)
{
    if (null === $format) {
    ...
    return wt_twig_date_converter($env, $date, $timezone)->format($format);
}
 ...
 */
function wt_twig_date_modify_filter(Environment $env, $date, $modifier)
{
    $date = wt_twig_date_converter($env, $date, false);
 ...
 * @return \DateTimeInterface
 */
function wt_twig_date_converter(Environment $env, $date = null, $timezone = null)
{
 ...
 * @return string
 */
function wt_twig_replace_filter($str, $from)
{
    if (!wt_twig_test_iterable($from)) {
        throw new RuntimeError(sprintf('The "replace" filter expects an array or "Traversable" as replace values, got "%s".', \is_object($from) ? \get_class($from) : \gettype($from)));
    }

    return strtr($str, wt_twig_to_array($from));
}
 ...
 */
function wt_twig_round($value, $precision = 0, $method = 'common')
{
    if ('common' === $method) {
 ...
 */
function wt_twig_number_format_filter(Environment $env, $number, $decimal = null, $decimalPoint = null, $thousandSep = null)
{
 ...
 */
function wt_twig_urlencode_filter($url)
{
    if (\is_array($url)) {
 ...
 */
function wt_twig_array_merge($arr1, $arr2)
{
    if (!wt_twig_test_iterable($arr1)) {
    ...
    return array_merge(wt_twig_to_array($arr1), wt_twig_to_array($arr2));
}
 ...
 */
function wt_twig_slice(Environment $env, $item, $start, $length = null, $preserveKeys = false)
{
 ...
 */
function wt_twig_first(Environment $env, $item)
{
    $elements = wt_twig_slice($env, $item, 0, 1, false);
 ...
 */
function wt_twig_last(Environment $env, $item)
{
    $elements = wt_twig_slice($env, $item, -1, 1, false);
 ...
 */
function wt_twig_join_filter($value, $glue = '', $and = null)
{
    if (!wt_twig_test_iterable($value)) {
        $value = (array) $value;
    }

    $value = wt_twig_to_array($value, false);
 ...
 */
function wt_twig_split_filter(Environment $env, $value, $delimiter, $limit = null)
{
 ...
 * @internal
 */
function wt_twig_default_filter($value, $default = '')
{
 ...
 */
function wt_twig_get_array_keys_filter($array)
{
 ...
 */
function wt_twig_reverse_filter(Environment $env, $item, $preserveKeys = false)
{
    if ($item instanceof \Traversable) {
    ...
    if ('UTF-8' !== $charset) {
        $item = wt_twig_convert_encoding($string, 'UTF-8', $charset);
    }
    ...
    if ('UTF-8' !== $charset) {
        $string = wt_twig_convert_encoding($string, $charset, 'UTF-8');
    }
 ...
 * @return array
 */
function wt_twig_sort_filter($array, $arrow = null)
{
    if ($array instanceof \Traversable) {
 ...
 * @internal
 */
function wt_twig_in_filter($value, $compare)
{
    ...
    foreach ($compare as $item) {
        if (0 ===wt_twig_compare($value, $item)) {
            return true;
        }
    }
 ...
 */
function wt_twig_trim_filter($string, $characterMask = null, $side = 'both')
{
 ...
 * @return string
 */
function wt_twig_spaceless($content)
{
    return trim(preg_replace('/>\s+</', '><', $content));
}

function wt_twig_convert_encoding($string, $to, $from)
{
 ...
 */
function wt_twig_length_filter(Environment $env, $thing)
{
    if (null === $thing) {
        return 0;
    }
 ...
 */
function wt_twig_upper_filter(Environment $env, $string)
{
 ...
 */
function wt_twig_lower_filter(Environment $env, $string)
{
 ...
 */
function wt_twig_title_string_filter(Environment $env, $string)
{
 ...
 */
function wt_twig_capitalize_string_filter(Environment $env, $string)
{
    $charset = $env->getCharset();
 ...
 * @internal
 */
function wt_twig_call_macro(Template $template, string $method, array $args, int $lineno, array $context, Source $source)
{
 ...
 * @internal
 */
function wt_twig_ensure_traversable($seq)
{
 ...
 * @internal
 */
function wt_twig_to_array($seq, $preserveKeys = true)
{
 ...
 */
function wt_twig_test_empty($value)
{
 ...
 */
function wt_twig_test_iterable($value)
{
 ...
 */
function wt_twig_include(Environment $env, $context, $template, $variables = [], $withContext = true, $ignoreMissing = false, $sandboxed = false)
{
 ...
 */
function wt_twig_source(Environment $env, $name, $ignoreMissing = false)
{
 ...
 * @return string
 */
function wt_twig_constant($constant, $object = null)
{
    if (null !== $object) {
 ...
 * @return bool
 */
function wt_twig_constant_is_defined($constant, $object = null)
{
    if (null !== $object) {
        $constant = \get_class($object).'::'.$constant;
    }
 ...
 * @return array
 */
function wt_twig_array_batch($items, $size, $fill = null, $preserveKeys = true)
{
 ...
 * @internal
 */
function wt_twig_get_attribute(Environment $env, Source $source, $object, $item, array $arguments = [], $type = /* Template::ANY_CALL */ 'any', $isDefinedTest = false, $ignoreStrictCheck = false, $sandboxed = false, int $lineno = -1)
{
    // array
 ...
 */
function wt_twig_array_column($array, $name, $index = null): array
{
    if ($array instanceof Traversable) {
        $array = iterator_to_array($array);
    } elseif (!\is_array($array)) {
...
function wt_twig_array_filter(Environment $env, $array, $arrow)
{
...
function wt_twig_array_map(Environment $env, $array, $arrow)
{
    if (!$arrow instanceof Closure && $env->hasExtension('\Twig\Extension\SandboxExtension') && $env->getExtension('\Twig\Extension\SandboxExtension')->isSandboxed()) {
...
function wt_twig_array_reduce(Environment $env, $array, $arrow, $initial = null)
{
    if (!$arrow instanceof Closure && $env->hasExtension('\Twig\Extension\SandboxExtension') && $env->getExtension('\Twig\Extension\SandboxExtension')->isSandboxed()) {
