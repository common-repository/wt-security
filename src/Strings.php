...
__('The reCAPTCHA module integrates with the Google API and is used to protect the site from spam and abuse, distinguishing between automatic and human actions. This module helps to prevent automatic registrations, comments and other unwanted activity on the site.', 'wtotem');
__('More information about Google reCAPTCHA can be found at this <a>link</a>', 'wtotem');
__('This authorization attempts module for Wordpress is an extended version, we recommend using it instead of the external version.', 'wtotem');
__('Disable user enumeration', 'wtotem');
...
__('Size', 'wtotem');
__('This log shows confidential files that may contain sensitive data. These files require attention to prevent potential information leaks.', 'wtotem');
__('This log shows links that were found in files or on site pages. Check the legitimacy of the links, in case they were added without your knowledge, take appropriate measures to ensure the security of the site.', 'wtotem');
__('This log shows the scripts that were connected to the site. Check the legitimacy of the scripts, in case they were added without your knowledge, take appropriate measures to ensure the security of the site.', 'wtotem');
__('This log shows frames (iframes). These elements can embed external resources on the site, if they were added without your knowledge, take appropriate measures to ensure the security of the site.', 'wtotem');
__('This log shows known vulnerabilities corresponding to the versions of the plugins you have installed. These vulnerabilities may pose a threat to the security of the site. You can update the plugin to the latest version, uninstall the plugin, or use another solution.', 'wtotem');
__('The date the file was last edited', 'wtotem');
__('The path to the file relative to the root directory', 'wtotem');
__('Make sure that these links have been added by you, and take action if necessary.', 'wtotem');
__('Make sure that these scripts have been added by you, and take action if necessary.', 'wtotem');
__('Make sure that these iframes have been added by you, and take action if necessary.', 'wtotem');
__('The source or path to the file/page where this link was found', 'wtotem');
__('Link type: Internal, leads to the site pages. External, leads to external resources.', 'wtotem');
__('Vulnerabilities in plugins', 'wtotem');
__('The name of the file and the link to this file.', 'wtotem');
__('The CVE ID, as well as a link to detailed information about this CVE', 'wtotem');
__('Update', 'wtotem');
__('Updating', 'wtotem');
